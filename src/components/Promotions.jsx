...
import img3 from "../assets/img/produtos/14.png";
...
import img9 from "../assets/img/produtos/8.jpg";
 ...
 function Promotions() {
  ...
  <p class="card-text">Armazenamento: 128GB<br/>RAM: 4 GB<br/>Foto: 50 Mpx<br/>Video: 4K </p>
    <a href="https://wa.me/558398712529?text=tenho%interesse%no%redmi%note%11" target='_blank' className="btn btn-success">Tenho Interesse!</a>
  </div>
...
1920x1080</p>
    <a href="https://wa.me/558398712529?text=tenho%interesse%no%iphone%8" target='_blank' className="btn btn-success">Tenho Interesse!</a>
  </div>
...
<div class="card" style={{width: "18rem", margin:"1.5em"}}>
  ...
  <div class="card-body">
    ...
    <p class="card-text">Armazenamento: 128GB <br/>Foto: 12 Mpx <br/>Video: 4K <br/>Display: 6.7
2778x1284</p>
    <a href="https://wa.me/558398712529?text=tenho%interesse%no%iphone%13" target='_blank' className="btn btn-success">Tenho Interesse!</a>
  </div>
